...
from utilities.anchor_generator import generate_anchors
from utilities.anchor_decode import decode_bbox
from utilities.nms import single_class_non_max_suppression
...
def extract_images(filename):
    ...
    filepath = os.path.join(Path("../FaceMaskDataset/train"), '*g')
...
def process():
    ...
    image_ids = extract_images(filepath) 
    
    # Image has been resized to (360, 360) and normalised to (0, 1).
    # output_info - [class_id, conf, xmin, ymin, xmax, ymax]
    ...
    for img_path in image_ids:
        ...
        # image, output_info = inference(img, show_result=False, target_shape=(360, 360))
        image, output_info = inference(img, show_result=False)
...
if __name__ == "__main__":
    ...
    # # Image has been resized and normalised to (0, 1).
    # # output_info - [class_id, conf, xmin, ymin, xmax, ymax]
    # # class_id [0: Mask, 1: No_mask]
    # show_one_image = True
